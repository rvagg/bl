...
bufferHasIndexOf && tape('successful indexOf search for byte', function (t) {
  ...
  var bl = new BufferList()
    , a = new Buffer([0x10, 0x34, 0x64, 0x03, 0xA5, 0x8B, 0x30, 0xFF, 0xE1])
    , b = new Buffer([0x24, 0xDE, 0xAD, 0xBE, 0xEF, 0x77, 0x43, 0x00, 0x00])
    , c = new Buffer([0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07])

  bl.append(a)
  bl.append(b)
  bl.append(c)

  t.equal(bl.indexOf(0x03), 3)
...
bufferHasIndexOf && tape('successful indexOf search for multi-byte', function (t) {
  ...
  var bl = new BufferList()
    , a = new Buffer([0x10, 0x34, 0x30, 0x03, 0xA5, 0x8B, 0x30, 0xFF, 0xE1])
    , b = new Buffer([0x24, 0xDE, 0xAD, 0xBE, 0xEF, 0x77, 0x43, 0x00, 0x00])
    , c = new Buffer([0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07])
    , searchBuffer = new Buffer([0x30, 0xFF, 0xE1, 0x24, 0xDE])

  bl.append(a)
  bl.append(b)
  bl.append(c)

  t.equal(bl.indexOf(searchBuffer), 6)
...
bufferHasIndexOf && tape('failing indexOf search for multi-byte', function (t) {
  ...
  var bl = new BufferList()
    ...
    , b = new Buffer([0x24, 0xDE, 0xAD, 0xBE, 0xEF, 0x77, 0x43, 0x00, 0x00])
    , c = new Buffer([0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07])
    , searchBuffer = new Buffer([0x30, 0xFF, 0xE2, 0x24, 0xDE])

  bl.append(a)
  bl.append(b)
  bl.append(c)

  t.equal(bl.indexOf(searchBuffer), -1)
  t.equal(bl.indexOf(searchBuffer, 4), -1)
})
